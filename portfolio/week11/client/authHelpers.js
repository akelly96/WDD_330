...
export async function makeRequest(url, method = 'GET', body = null, token = null) {
    ...
    // ie bad username/password combination, and a 404 if the URL we requested does not exist. All of 
    // these would cause response.ok to be false
...
export default class Errors {
    ...
    displayError(error) {
        ...
        `
        setTimeout(function(errorElement) {
            errorElement.innerHTML = "";
        }, 2000, this.errorElement);
    }
}
