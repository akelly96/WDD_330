...
const myComments = new Comments('hikeComments');
...
const hikeList = [
  ...
  export default class Hikes {
    ...
    showOneHike(hike) {
        ...
        let commentSection = document.createElement("h2");
        commentSection.innerHTML = "COMMENTS";
        this.parent.appendChild(commentSection);
        myComments.displayForm();
    }
    ...
    addHikeListener() {
        ...
        hikes.forEach(hike => {
            document.getElementById(hike.name).addEventListener("click", () => {
                ...
                myComments.selectedHike = hike.name;
                myComments.showOneHikeComments();
            });
        });
